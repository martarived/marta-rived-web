...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .proj-split-media video { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; display: block; }
...
<section id="hero">
  ...
  <div id="hero-content">
    ...
    <h1 class="hero-title">
      Vivir<br>
      <span class="dim">pese a la</span><br>
      enfermedad
    </h1>
  </div>
</section>
...
<div class="proj-meta">
  <div class="proj-meta-item">
    <p class="proj-meta-label">Cliente</p>
    <p class="proj-meta-value">Bayer</p>
  </div>
  <div class="proj-meta-item">
    <p class="proj-meta-label">Medio</p>
    <p class="proj-meta-value">La Vanguardia</p>
  </div>
  <div class="proj-meta-item">
    <p class="proj-meta-label">Año</p>
    <p class="proj-meta-value">2024</p>
  </div>
  <div class="proj-meta-item">
    <p class="proj-meta-label">Rol</p>
    <p class="proj-meta-value">Guion · Redacción · Dirección creativa</p>
  </div>
</div>
...
<div class="proj-stats">
  <div class="proj-stat">
    <p class="proj-stat-num">43%</p>
    <p class="proj-stat-label">de todos los ensayos clínicos autorizados en la UE en 2023 se realizaron en hospitales españoles</p>
  </div>
  <div class="proj-stat">
    <p class="proj-stat-num">10</p>
    <p class="proj-stat-label">fármacos aprobados desde 2004 que han demostrado prolongar la supervivencia en cáncer de próstata metastásico</p>
  </div>
  <div class="proj-stat">
    <p class="proj-stat-num">770K</p>
    <p class="proj-stat-label">personas afectadas por insuficiencia cardíaca en España, con una supervivencia del 50% a los 5 años del diagnóstico</p>
  </div>
</div>
